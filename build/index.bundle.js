(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('node:fs/promises'), require('node:path'), require('node:url'), require('path')) :
	typeof define === 'function' && define.amd ? define(['exports', 'node:fs/promises', 'node:path', 'node:url', 'path'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.$ = {}, global.promises, global.path, global.node_url, global.path$1));
})(this, (function (exports, promises, path, node_url, path$1) { 'use strict';
	...
	function currentPath(importMeta, ...joinPaths) {
		...
		const currentPathString = path$1.dirname(node_url.fileURLToPath(importMeta.url));
	...
	function writeText(path, contents) {
		return promises.writeFile(path, contents, 'utf8');
	}
	/**
	...
	function writeJSON(path, value, indent = 2) {
		return promises.writeFile(path, JSON.stringify(value, null, indent), 'utf8');
	}
	/**
	...
	exports.concurrentEach = concurrentEach;
	...
	exports.forCompactMap = forCompactMap;
	...
	exports.getCollectionInsertIndex = getCollectionInsertIndex;
	...
	exports.isErrorCall = isErrorCall;
