(function (global, factory) {
   ...
   * }), [true, true]);
   */
  async function filterAsyncArray(
    source,
    iteratee,
    results = [],
    additionalArgument,
  ) {
    await eachAsyncArray(
      source,
      async (item, index, arrayOriginal, arrayLength) => {
        if (
          (await iteratee(
            item,
            index,
  ...
  function get(propertyString, target) {
    ...
    let link = target;
    const pathArray = isArray(propertyString)
      ? propertyString
  ...
  function isTypeNameFactory(source) {
    return (target) => {
      ...
      return (
        (constructorNameString && constructorNameString === source) || false
      );
    };
  }
  ...
  const isPlainObject = (source) => {
    if (hasValue(source)) {
      return source.constructor.toString().trim().slice(9, 16) === "Object(";
    }
    return false;
  };
  ...
  function last(array, indexFrom) {
    ...
    return indexFrom
      ? array.slice(arrayLength - indexFrom, arrayLength)
      : array[arrayLength - 1];
  }
  ...
  function sortCollectionDescendingFilter(
    previous,
    next,
    propertyName,
    ifMatch,
  ...
  function sortCollectionDescending(collection, propertyName = "id", ifMatch) {
    return collection.sort((previous, next) => {
      return sortCollectionDescendingFilter(
        previous,
        next,
        propertyName,
        ifMatch,
  ...
  function sortCollectionAscendingFilter(
    previous,
    next,
    propertyName,
    ifMatch,
  ...
  function sortCollectionAscending(collection, propertyName = "id", ifMatch) {
    return collection.sort((previous, next) => {
      return sortCollectionAscendingFilter(
        previous,
        next,
        propertyName,
        ifMatch,
  ...
  function sortObjectsAlphabeticallyReverse(
    previous,
    next,
    propertyName,
    ifMatch,
  ...
  function sortCollectionAlphabeticallyReverse(
    ...
    return collection.sort((previous, next) => {
      return sortObjectsAlphabeticallyReverse(
        previous,
        next,
        propertyName,
        ifMatch,
  ...
  async function mapAsyncObject(source, iteratee, results = {}) {
    ...
    await eachAsyncObject(
      source,
      async (item, key, thisObject, propertyCount, objectKeys) => {
        results[key] = await iteratee(
          item,
          key,
          results,
          thisObject,
  ...
  async function everyAsyncObject(source, iteratee) {
    ...
    const objectKeys = keys(source);
    return everyAsyncArray(
      objectKeys,
      (key, index, original, propertyCount) => {
   ...
   * }), false);
   */
  async function forOfEveryAsync(
    source,
    iteratee = returnValue,
    generatorArgs,
  ) {
   ...
   * }), {a: 1, c: 3});
   */
  async function compactMapAsyncObject(
    source,
    iteratee = returnValue,
    results = {},
  ) {
    await eachAsyncObject(
      source,
      async (item, key, original, propertyCount, objectKeys) => {
        const result = await iteratee(
          item,
          key,
          results,
          original,
  ...
  function filterObject(source, iteratee, results = {}) {
    eachObject(source, (item, key, original, propertyCount, objectKeys) => {
      if (
        iteratee(item, key, results, original, propertyCount, objectKeys) ===
        true
      ) {
        results[key] = item;
      }
  ...
  function truncate(string, maxLength) {
    ...
    return stringLength > maxLength
      ? truncateDown(string, maxLength, stringLength)
      : string;
  }
  /**
  ...
  function truncateRight(string, maxLength) {
    const stringLength = string.length;
    return stringLength > maxLength
      ? truncateUp(string, maxLength, stringLength)
      : string;
  }
  ...
  function isTypedArray(source) {
    if (source) {
      ...
      if (
        typedArrayRegex.test(constructorName) &&
        constructorName !== arrayConstructorName
      ) {
        return true;
      }
    }
  ...
  async function assertAsync(sourceArg, expected, options) {
    ...
    const expectedFunction =
      isFunction(expected) && (await expected(source, options)) === false;
  ...
  function assert(source, expected, options) {
    ...
    const expectedFunction =
      isFunction(expected) && expected(source, options) === false;
    if (expectedFunction || notEqual(source, expected)) {
      return createAssertError(source, expected, options);
    }
    return true;
  ...
  async function concurrent(source, thisBind, ...args) {
    ...
    if (thisBind) {
      for (let index = 0; index < arrayLength; index++) {
        ...
        results[index] = source[index].call(
          thisBind,
          ...args,
          index,
          results,
   ...
   * assert(temp, {b: 2, c: 3});
   */
  async function forOfCompactMapAsync(
    source,
    iteratee = returnValue,
    resultsObject,
    generatorArgs,
   ...
   * assert(temp, {b: 2, c: 3});
   */
  async function forOfFilterAsync(
    source,
    iteratee = returnValue,
    resultsObject,
    generatorArgs,
  ...
  async function inAsync(source, thisBind, ...args) {
    ...
    if (thisBind) {
      for (let index = 0; index < arrayLength; index++) {
        const callable = source[index];
        results[index] = await source[index].call(
          thisBind,
          ...args,
          index,
          callable,
  ...
  function isDocumentReady(callable) {
    ...
    const checkStatus =
      state === "interactive" || state === "completed" || state === "complete";
    if (checkStatus) {
  ...
  isDocumentReady(() => {
    ...
    const scriptName =
      (scriptTag && scriptTag.getAttribute("data-index")) || "/index";
    importjs(scriptName);
  });
  ...
  const cnsl = (value, themeName) => {
    ...
    if (themeName === "alert" || themeName === "warning") {
      return console.trace(
        `%c${data}`,
        `${themes[themeName]}font-size:13px;padding:2px 5px;border-radius:2px;`,
      );
    }
    console.log(
      `%c${data}`,
  ...
  function isHTMLCollection(source) {
    return hasValue(source)
      ? source.toString() === objectHTMLCollection
      : false;
  }
  /**
  ...
  exports.assignToClass = assignToClass;
  ...
  exports.concurrentEachArray = concurrentEachArray;
  ...
  exports.eachAsyncArray = eachAsyncArray;
  exports.eachAsyncObject = eachAsyncObject;
  ...
  exports.forOf = forOf;
  exports.forOfAsync = forOfAsync;
  exports.forOfCompactMap = forOfCompactMap;
  exports.forOfCompactMapAsync = forOfCompactMapAsync;
  exports.forOfEvery = forOfEvery;
  exports.forOfEveryAsync = forOfEveryAsync;
  exports.forOfFilter = forOfFilter;
  exports.forOfFilterAsync = forOfFilterAsync;
  exports.forOfMap = forOfMap;
  ...
  exports.getConstructor = getType;
  exports.getConstructorName = getTypeName;
  ...
  exports.ifNotAssign = ifNotAssign;
  ...
  exports.isBigIntCall = isBigIntCall;
  exports.isBoolean = isBoolean;
  exports.isBooleanCall = isBooleanCall;
  exports.isBuffer = isBuffer;
  exports.isBufferCall = isBufferCall;
  exports.isChild = isChild;
  exports.isCloneable = isCloneable;
  exports.isConstructor = isType;
  ...
  exports.isGeneratorCall = isGeneratorCall;
  exports.isHTMLCollection = isHTMLCollection;
  exports.isI16 = isI16;
  exports.isI16Call = isI16Call;
  exports.isI32 = isI32;
  ...
  exports.isTypeNameFactory = isTypeNameFactory;
  exports.isTypedArray = isTypedArray;
  exports.isU16 = isU16;
  exports.isU16Call = isU16Call;
  exports.isU32 = isU32;
  exports.isU32Call = isU32Call;
  exports.isU8 = isU8;
  exports.isU8C = isU8C;
  exports.isU8CCall = isU8CCall;
  exports.isU8Call = isU8Call;
  exports.isUndefined = isUndefined;
  exports.isWeakMap = isWeakMap;
  exports.isWeakMapCall = isWeakMapCall;
  exports.isZero = isZero;
  exports.jsonParse = jsonParse;
  exports.jsonParseNative = jsonParseNative;
  exports.jsonParseTry = jsonParseTry;
  ...
  exports.sortCollectionAlphabeticallyReverse =
  ...
  exports.timers = timers;
  exports.times = times;
  exports.timesAsync = timesAsync;
  exports.timesMap = timesMap;
  exports.timesMapAsync = timesMapAsync;
  ...
  exports.untilFalseArray = untilFalseArray;
  exports.untilTrueArray = untilTrueArray;
